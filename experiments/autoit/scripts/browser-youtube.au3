; Open Edge and navigate to YouTube to search for new devices
Local $sSearchTerm = "new devices"
Local $sURL = "https://www.youtube.com"
...
; Directly click on the YouTube search box
; NOTE: Adjust these coordinates (600, 105) as needed for your screen/resolution.
MouseClick("left", 1050, 105, 1, 10)
Sleep(500)
